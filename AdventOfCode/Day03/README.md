## Day 3: Mull It Over
"_Our computers are having issues, so I have no idea if we have any Chief Historians in stock! You're welcome to check the warehouse, though_," says the mildly flustered shopkeeper at the North Pole Toboggan Rental Shop. The Historians head out to take a look.

The shopkeeper turns to you. "_Any chance you can see why our computers are having issues again?_"
...
The `do()` instruction enables future mul instructions. </br>
The `don't()` instruction disables future mul instructions. </br>
